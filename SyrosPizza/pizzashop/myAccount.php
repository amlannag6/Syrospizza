		...
		<div class = "myAccount">
			...
			<?php
				...
				if(mysqli_num_rows($qry1_run) > 0)
				{
					...
					echo '<tr><th> Date/Time </th><th> Pizza Name </th><th> Size </th><th> Quantity </th><th> Extra Cheese </th><th> Topping </th><th> Crust </th><th> Payment Method </th><th> Amount (CAD) </th><th> Order Type </th><th> Order Status </th></tr>';
